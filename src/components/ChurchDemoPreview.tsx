          ...
          <div className="flex flex-wrap items-center justify-between border-b border-white/10 px-3 sm:px-6 py-3 bg-[rgba(10,28,59,0.4)]">
            <div className="flex items-center gap-1.5 sm:gap-3 overflow-x-auto pb-1 sm:pb-0 w-full sm:w-auto">
              ...
              >
                ...
                <span>{t.demo.tabs.messages}</span>
              </button>
            ...
            <div className="hidden lg:flex items-center gap-2 text-xs font-semibold text-blue-200/80">
              ...
              <span>{t.security.pillars[0]?.badge || '100% Offline'}</span>
            </div>
          </div>
            ...
            <div className="p-4 sm:p-6 space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 justify-between items-stretch sm:items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs text-blue-200/60">Total: <b>{filteredMembers.length}</b></span>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs sm:text-sm">
                    <thead className="bg-white/5 text-blue-200/70 font-semibold border-b border-white/10">
                      <tr>
                        <th className="py-3 px-4">Non</th>
                        <th className="py-3 px-4">Wòl</th>
                        <th className="py-3 px-4">Gwoup</th>
              ...
              <form onSubmit={handleSendAnnouncement} className="p-4 rounded-xl bg-black/30 border border-white/10 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-white flex items-center gap-1.5">
                    ...
                    <span>Difize yon Anons / SMS</span>
                  </span>
                  <span className="text-[11px] text-green-400 font-semibold">1,248 manm</span>
                </div>
                ...
                <textarea
                  ...
                  placeholder="Ekri anons ou a la a..."
                ...
                <div className="flex items-center justify-between pt-1">
                  <span className="text-[11px] text-blue-200/50">SMS &amp; Push</span>
                  <button
                    type="submit"
                ...
                {sendSuccess && (
                  <div className="p-2.5 rounded-xl bg-green-950/60 border border-green-500/40 text-green-400 text-xs font-bold flex items-center gap-2 animate-fadeIn">
                    ...
                    <span>Anons la voye avèk siksè!</span>
                  </div>
                )}
              </form>
            ...
            <div className="p-4 sm:p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="metric-card p-4">
                  ...
                  <div className="text-xs text-green-400 font-semibold mt-1">+8.4%</div>
                </div>
                ...
                <div className="metric-card p-4">
                  ...
                  <div className="text-xs text-[#35c9ff] font-semibold mt-1">100%</div>
                </div>
                ...
                <div className="metric-card p-4">
                  ...
                  <div className="text-xs text-green-400 font-semibold mt-1">92.5%</div>
                </div>
              </div>
            </div>
          )}
