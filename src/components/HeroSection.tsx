        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-6 relative">
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs font-semibold text-blue-100/80 leading-none">{t.download.androidCard.btn.split(' ')[0]}</div>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs font-semibold text-blue-200/60 leading-none">{t.download.pcCard.btn.split(' ')[0]} PC</div>
              ...
              <div className="flex items-center gap-2 text-xs text-blue-200/60 pt-0.5">
                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/15 text-amber-300 border border-amber-500/30">
                  {t.download.iosCard.btn}
                </span>
                <span>{t.hero.comingSoonIos}</span>
              </div>
              ...
              {downloadFeedback && (
                <div className="p-3 rounded-xl bg-green-950/70 border border-green-500/40 text-green-300 text-xs font-bold flex items-center gap-2 animate-fadeIn">
                  ...
                  <span>{downloadFeedback} — {t.modals.copied || 'Download started!'}</span>
                </div>
              )}
              ...
              {comingSoonNotice && (
                <div className="p-3.5 rounded-xl bg-amber-950/80 border border-amber-500/40 text-amber-200 text-xs font-medium flex items-start gap-2.5 animate-fadeIn">
                  ...
                  <div>
                    <span className="font-bold text-amber-300 block">Coming Soon:</span>
                    {comingSoonNotice}
                  </div>
                </div>
              )}
            ...
            <div className="pt-2 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-blue-200/60">
              ...
              <span className="flex items-center gap-1.5 text-blue-200/90 font-medium">
                <CheckCircle2 className="w-4 h-4 text-green-400" />
                <span>{t.hero.fastOffline}</span>
              </span>
              <span className="flex items-center gap-1.5 text-blue-200/90 font-medium">
                <CheckCircle2 className="w-4 h-4 text-green-400" />
                <span>{t.hero.securePrivacy}</span>
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
              <div className="glass p-3 rounded-2xl text-center hover:border-cyan-400/40 transition-colors">
                ...
                <div className="text-xs font-bold text-white mt-1">{t.features.f1.title}</div>
                <div className="text-[10px] text-blue-200/50">{t.features.f1.badge}</div>
              </div>
              <div className="glass p-3 rounded-2xl text-center hover:border-cyan-400/40 transition-colors">
                <div className="text-lg">📷</div>
                <div className="text-xs font-bold text-white mt-1">{t.features.f2.title}</div>
                <div className="text-[10px] text-blue-200/50">{t.features.f2.badge}</div>
              </div>
              <div className="glass p-3 rounded-2xl text-center hover:border-cyan-400/40 transition-colors">
                <div className="text-lg">📢</div>
                <div className="text-xs font-bold text-white mt-1">{t.features.f3.title}</div>
                <div className="text-[10px] text-blue-200/50">{t.features.f3.badge}</div>
              </div>
              <div className="glass p-3 rounded-2xl text-center hover:border-cyan-400/40 transition-colors">
                <div className="text-lg">🔒</div>
                <div className="text-xs font-bold text-white mt-1">{t.features.f4.title}</div>
                <div className="text-[10px] text-blue-200/50">{t.features.f4.badge}</div>
              </div>
            </div>
