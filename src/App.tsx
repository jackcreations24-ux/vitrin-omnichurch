...
export default function App() {
  ...
  // Secret dev panel triggers:
  // 1. Secret hotkey: Ctrl + Shift + D (or Cmd + Shift + D)
  // 2. Secret URL hash: #dev or #admin
  // 3. Continuous 10-second hold on the Live green indicator pill
  useEffect(() => {
